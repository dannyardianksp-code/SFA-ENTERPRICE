...
// - MD, SPG, SALES tidak termasuk -- ketiga role ini defaultnya TIDAK
//   PUNYA akses web sama sekali (can_access_web default false, cuma
//   dibuka manual per-user lewat form Edit User), jadi percuma diatur
//   Menu Access-nya.
